...
namespace guestHouse.Controllers
{
    ...
    public class TestimonialsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,avatar,comment,name,stars")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,avatar,comment,name,stars")] Testimonial testimonial)
        {
            if (ModelState.IsValid)
            {
